...
integer :: costh_steps, ph_steps, costhq_steps, phq_steps, costhl_steps, phl_steps, Ee_steps, mW_steps
integer :: num_args, ix
...
real(kind=omega_prec) :: costh, ph, costhq, phq, costhl, phl, mW, Wrange, E, Ee, ECMS, tempG, tempH
...
if(filestat(1)==0 .AND. filestat(2)==0) then
	...
	costhq = ( 1.9_omega_prec / dble(costhq_steps-1_omega_prec) ) * (A(3)-1_omega_prec) - 0.95_omega_prec
	...
	do iphl=1,phl_steps
		...
		write(30,*) costh, costhl, phl, Ee, costhq, phq, MatrixElement(1,1:40)
		write(31,*) costh, costhl, phl, Ee, costhq, phq, MatrixElement(2,1:40)	
