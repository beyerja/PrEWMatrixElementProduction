...
integer :: icosthq, iphq, iph, imWp, imWm
...
if(filestat(1)==0 .AND. filestat(2)==0) then
	...
	phl = ( 2_omega_prec * PI / dble(phl_steps) ) * (A(3)-1_omega_prec)
	...
	do iphq=1,phq_steps
		...
		write(30,*) costh, costhl, phl, costhq, phq, MatrixElement(1,1:40)
		write(31,*) costh, costhl, phl, costhq, phq, MatrixElement(2,1:40)
	end do	
	end do
else
